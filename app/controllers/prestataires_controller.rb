class PrestatairesController < Application2Controller
  ...
  private
    ...
    def prestataire_params
      params.require(:prestataire).permit(:email,:sexe,:first_name,:last_name,:date_of_birth,:raison_sociale,:siren,:tel,:adresse,:adresse_complet,:zip_code,:ville,:pays, :statut)
    end
end