...
#================================================================================#
  ...
  post "/admin/commande-numero/:id", to:'admin_order#update_status_order', as:"admin_update_status_order"
...
#   post '/reservation-prestation/paye-commande', to:'orders#payment', as: "payment"
  post '/reservation-prestation/paye-commande/:client_id', to:'orders#payment', as: "payment"
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
  ...
  get "/admin/update_orders", to: "notification#verify_process_order", as:"update_orders"
end
